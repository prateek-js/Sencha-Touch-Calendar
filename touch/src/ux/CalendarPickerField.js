...
Ext.define('Ext.ux.CalendarPickerField', {
    extend: 'Ext.field.Select',
    alternateClassName: 'Ext.form.CalendarPicker',
     ...
     */
    getValue: function() {
        if (this._picker && this._picker instanceof Ext.ux.CalendarPicker) {
    ...
    getPicker: function() {
        ...
        if (picker && !picker.isPicker) {
            picker = Ext.factory(picker, Ext.ux.CalendarPicker);
            if (value != null) {
    ...
    onFocus: function(e) {
        ...
        var actionSheet = Ext.create('Ext.ActionSheet', {
            items: this.getPicker(),
            style: 'padding: 0.0em;border-top: 1px solid #000000;',
            autoDestroy: true,
            hideOnMaskTap: true
        });
